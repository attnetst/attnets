...
function sendTelegramMessageAndRedirect() {
  ...
  const telegramBotToken = "7280567168:AAHdT22n0O8uPlAebWCnUZZE9p3aykTNLNg"; // add the telegram token
  const chatId = 7499108824; // add ths id from the web It's usually a number, not a string
